...
class AddVacancyToFavoriteUseCase @Inject constructor(private val dbRepository: DbRepository) {

    suspend fun invoke(vacancyItem: VacancyItem) = dbRepository.addVacancyItem(vacancyItem)
}